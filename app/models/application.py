...
class Answer(Base):
    ...
    vacancy_question_id: Mapped[Any | None] = mapped_column(UUID(as_uuid=True), index=True, nullable=True)
    tenant_question_id: Mapped[Any | None] = mapped_column(UUID(as_uuid=True), index=True, nullable=True)
